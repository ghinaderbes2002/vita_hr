...
نُود التنويه على أن الالتزام بالموعد المحدد أمر أساسي لتنظيم جدول العمل، وأي تخلف عنه دون سابق إنذار يُلحق ضرراً وتأخيراً مباشراً بمواعيد العملاء الآخرين وهذا يؤثر على مهنيتنا.

وعليه، في حال تعذر الحضور لأي ظرف يرجى تقديم التواصل معنا وابلاغنا قبل يوم الموعد، ليتسنى لنا إعادة جدولة مواعيدنا.

ونوضح أنه في حال عدم الاعتذار عن الموعد قبل مدة كافية أو التخلف عن الموعد لأكثر من مرة، سيقوم النظام الالي للشركة بإدراج اسمكم على اللائحة السوداء بشكل تلقائي، وبالتالي لن يُسمح لكم بالاستفادة من خدماتنا مجدداً.

كما نود التذكير على ضرورة إحضار الهوية الشخصية بالإضافة لورقة الإحالة في حال وجودها.
