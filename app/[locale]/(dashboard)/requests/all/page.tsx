...
const TYPE_OPTIONS = ["TRANSFER", "RESIGNATION", "REWARD", "OTHER", "PENALTY_PROPOSAL", "OVERTIME_EMPLOYEE", "OVERTIME_MANAGER", "BUSINESS_MISSION", "DELEGATION", "HIRING_REQUEST", "COMPLAINT", "MAINTENANCE"];
              ...
              requests.map((req) => (
                ...
                >
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    {(req.status === "IN_APPROVAL" || req.status === "PENDING_HR" || req.status === "PENDING_MANAGER") && (canApprove || canReject) && (
