...
const AR = {
  ...
  useAsInstructed:
    ". وأتعهد باستخدامه حصراً وفقاً للتعليمات المكتوبة المرفقة به",
  explained:
  ...
  cause2:
    ". ثانياً: تعريض الطرف لصدمات أو أحمال أو استخدامات تتجاوز الحدود الموصى بها في تعليمات الشركة",
  cause3: ". ثالثاً: قيام جهة غير معتمدة من الشركة بأي تعديل أو إصلاح للطرف",
  finalTitle: " : ثالثاً: إقرار نهائي",
  finalStatement:
